...
const { getGlasses, getProductDetail, getPaginatedAndFilteredProduct, getPaginatedProductReviews, sendReviews, sendOrders, updateMultiple } = require("./productController");
...
router.patch('/api/stockUpdate', updateMultiple);
